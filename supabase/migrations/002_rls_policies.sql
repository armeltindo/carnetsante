...
-- ============================================================
-- Créer le bucket via dashboard Supabase ou:
-- INSERT INTO storage.buckets (id, name, public) VALUES ('medical-documents', 'medical-documents', false);

-- Politique storage: accès uniquement aux fichiers de l'utilisateur
-- Le chemin doit suivre: {user_id}/{family_member_id}/{filename}
